...
const noUnsafeDictionaryTypeRule = plugin.rules["no-unsafe-dictionary-type"];
...
tester.run("anti-slop/no-unsafe-dictionary-type", noUnsafeDictionaryTypeRule, {
  valid: [
    "interface Empty {} function run<Empty>(input: Record<string, Empty>) {}",
    "interface Empty {} function run() { interface Empty { id: string } type Values = Record<string, Empty>; }",
    "interface Empty {} function run() { type Empty = { id: string }; type Values = Record<string, Empty>; }",
  ...
  invalid: [
    { code: "function run() { interface Empty {} type Values = Record<string, Empty>; }", errors: [error] },
