...
} from "../shared/dictionary-types.mjs";
import {
  containsUnknownType,
  functionParameterBindingName,
  functionParameterTypeAnnotation
} from "../shared/function-parameters.mjs";
import { resolveVariable } from "../shared/scope.mjs";
...
/** Reject known-value widening while preserving precise inline contracts and empty accumulators. */
export const noKnownValueWideningRule = {
  ...
  create(context) {
    ...
    const reportFlow = (expression, destination, subject) => {
      // Fungsi permits precise inline object contracts; anonymity alone is not widening.
      if (destination === null || destination.kind === "anonymous object")
        return;
