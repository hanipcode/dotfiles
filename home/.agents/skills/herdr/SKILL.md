---
name: herdr
description: "Control Herdr panes, tabs, workspaces, commands, dev servers, background processes, and agents. Use only when the user explicitly mentions Herdr, asks for Herdr control, or another invoked skill explicitly requires Herdr. Do not use merely because background execution, delegation, or parallelism could be convenient. Requires HERDR_ENV=1."
---
